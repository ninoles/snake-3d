...
irr::gui::IGUIButton * Frame::addButton(const irr::core::rect<irr::s32>& __rectangle, irr::gui::IGUIElement* __parent,
									 irr::s32 __id, const wchar_t* __text, const wchar_t* __tooltiptext){

	return _guiEnv->addButton(__rectangle, __parent, __id, __text, __tooltiptext);
}
...
irr::scene::ICameraSceneNode* Frame::addCameraFPS(irr::scene::ISceneNode* __parent,
	...
	return _sceneMang->addCameraSceneNodeFPS(__parent, __rotateSpeed, __moveSpeed, __id, __keyMapArray, __keyMapSize, __noVerticalMovement, __jumpSpeed);
}

irr::scene::ICameraSceneNode* Frame::addCameraMaya(irr::scene::ISceneNode* __parent,
                                    irr::f32 __rotateSpeed, irr::f32 __zoomSpeed,
                                    irr::f32 __translationSpeed, irr::s32 __id){

	return _sceneMang->addCameraSceneNodeMaya(__parent, __rotateSpeed, __zoomSpeed, __translationSpeed, __id);
}
...
irr::gui::IGUIImage* Frame::addImage(const irr::c8* __filename, irr::core::position2d<irr::s32> __pos,
                                    bool __useAlphaChannel, irr::gui::IGUIElement* __parent, irr::s32 __id,
                                    const wchar_t* __text){

	return _guiEnv->addImage(_driver->getTexture(__filename), __pos, __useAlphaChannel, __parent, __id, __text);
}
...
irr::scene::ITerrainSceneNode* Frame::addTerrainSceneNode(const irr::c8* __filename, irr::scene::ISceneNode *__parent, irr::s32 __id,
	...
	return _sceneMang->addTerrainSceneNode(__filename, __parent, __id, __position,__rotation, __scale, __vertexColor, __maxLOD,__patchSize, __smoothFactor);
}

irr::scene::ISceneNode* Frame::addSkyBox(const irr::c8* __textureUp, const irr::c8* __textureDown, const irr::c8* __textureLeft,
									const irr::c8* __textureRight, const irr::c8* __textureFt, const irr::c8* __textureBk,
									irr::scene::ISceneNode *__parent, irr::s32 __id){

	return _sceneMang->addSkyBoxSceneNode(_driver->getTexture(__textureUp), _driver->getTexture(__textureDown), _driver->getTexture(__textureLeft),
											_driver->getTexture(__textureRight), _driver->getTexture(__textureFt), _driver->getTexture(__textureBk),
											__parent, __id);
}

irr::scene::ITriangleSelector* Frame::addSelectorNode(irr::scene::IMesh *__mesh, irr::scene::ISceneNode *__node){
	irr::scene::ITriangleSelector *selector =  _sceneMang->createTriangleSelector(__mesh, __node);
...
irr::scene::ITriangleSelector* Frame::addSelectorTerrainNode(irr::scene::ITerrainSceneNode *__node, irr::s32 __lod){
	irr::scene::ITriangleSelector *selector = _sceneMang->createTerrainTriangleSelector(__node, __lod);
...
irr::scene::ISceneNodeAnimator* Frame::addColision(irr::scene::ITriangleSelector *__trianguleSelector, irr::scene::ISceneNode *__sceneNode,
	...
	irr::scene::ISceneNodeAnimator *anim =  _sceneMang->createCollisionResponseAnimator(__trianguleSelector, __sceneNode, __ellipsoidRadius, __gravityPerSecond, __ellipsoidTranslatio, __slidingValue);
