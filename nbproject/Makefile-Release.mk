...
# CC Compiler Flags
CCFLAGS=-lIrrlicht -lGL -lGLU -lXext -lX11 -lXxf86vm
CXXFLAGS=-lIrrlicht -lGL -lGLU -lXext -lX11 -lXxf86vm
...
${OBJECTDIR}/Codes/Base/FrameImage.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameImage.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameImage.o Codes/Base/FrameImage.cpp
...
${OBJECTDIR}/Codes/Base/FrameOpenDialog.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameOpenDialog.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameOpenDialog.o Codes/Base/FrameOpenDialog.cpp
...
${OBJECTDIR}/Codes/Base/FrameFont.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameFont.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameFont.o Codes/Base/FrameFont.cpp
...
${OBJECTDIR}/Codes/Base/Frame.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/Frame.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/Frame.o Codes/Base/Frame.cpp

${OBJECTDIR}/Codes/Base/FrameButton.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameButton.o Codes/Base/FrameButton.cpp
...
${OBJECTDIR}/Codes/Base/FramText.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FramText.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FramText.o Codes/Base/FramText.cpp

${OBJECTDIR}/Codes/Base/FrameAnimatedNode.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameAnimatedNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameAnimatedNode.o Codes/Base/FrameAnimatedNode.cpp

${OBJECTDIR}/Codes/Base/FrameCameraMaya.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameCameraMaya.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameCameraMaya.o Codes/Base/FrameCameraMaya.cpp
...
${OBJECTDIR}/Codes/Base/FrameCameraFPS.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameCameraFPS.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameCameraFPS.o Codes/Base/FrameCameraFPS.cpp
...
${OBJECTDIR}/Codes/Base/FrameSkyBox.o: nbproject/Makefile-${CND_CONF}.mk Codes/Base/FrameSkyBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/Codes/Base
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Codes/Base/FrameSkyBox.o Codes/Base/FrameSkyBox.cpp
